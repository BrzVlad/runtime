...
struct InterpInst
{
    ...
    union
    {
        ...
        InterpBasicBlock **ppTargetBBTable;
        InterpCallInfo *pCallInfo;
    } info;
...
private:
    ...
    InterpInst* FirstIns(InterpBasicBlock *pBB);
    InterpInst* NextIns(InterpInst *pIns);
    InterpInst* PrevIns(InterpInst *pIns);
