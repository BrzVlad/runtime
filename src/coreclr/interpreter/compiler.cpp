...
InterpOpcode InterpCompiler::InterpGetMovForType(InterpType interpType, bool signExtend)
{
    switch (interpType)
    {
        case InterpTypeI1:
...
void InterpCompiler::EmitBinaryArithmeticOp(InterpOpcode opBase)
{
    CHECK_STACK_RET_VOID(2);
    ...
    InterpOpcode finalOpcode = (InterpOpcode)((int32_t)opBase + typeOffset);
...
void InterpCompiler::EmitUnaryArithmeticOp(InterpOpcode opBase)
{
    CHECK_STACK_RET_VOID(1);
    StackType stackType = m_pStackPointer[-1].type;
    InterpOpcode finalOpcode = (InterpOpcode)((int32_t)opBase + stackType - StackTypeI4);
...
void InterpCompiler::EmitShiftOp(InterpOpcode opBase)
{
    CHECK_STACK_RET_VOID(2);
