...
// R2R Version 18.3 adds ThrowArgumentOutOfRange, ThrowArgument, ThrowPlatformNotSupported, ThrowNotImplemented helpers
...
enum ReadyToRunHelper
{
    ...
    READYTORUN_HELPER_ThrowArgumentOutOfRange   = 0x28,
    READYTORUN_HELPER_ThrowArgument             = 0x29,
