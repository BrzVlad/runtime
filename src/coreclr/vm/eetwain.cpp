                                        ...
                                        DWORD           relOffsetOverride)
{
    ...
    // GC reporting for interpreter frames is handled in bulk by InterpreterFrame::GcScanRoots_Impl
    // which conservatively scans the entire interpreter stack. We do not report individual slots here.
    return true;
}
