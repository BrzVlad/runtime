...
namespace ILCompiler.DependencyAnalysis
{
    ...
    public sealed class NodeFactory
    {
        ...
        private NodeCache<MethodDesc, ReadyToRunGVMDependenciesNode> _gvmDependencies;

        public ReadyToRunGVMDependenciesNode GVMDependencies(MethodDesc method)
        {
            Debug.Assert(method.HasInstantiation);
            Debug.Assert(method.IsVirtual);
            return _gvmDependencies.GetOrAdd(method.GetCanonMethodTarget(CanonicalFormKind.Specific));
        }
        ...
        private void CreateNodeCaches()
        {
            ...
            _gvmDependencies = new NodeCache<MethodDesc, ReadyToRunGVMDependenciesNode>(method =>
            {
