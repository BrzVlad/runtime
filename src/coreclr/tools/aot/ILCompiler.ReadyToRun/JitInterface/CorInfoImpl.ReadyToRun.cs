...
namespace Internal.JitInterface
{
    ...
    unsafe partial class CorInfoImpl
    {
            ...
            out bool useInstantiatingStub)
        {
            ...
            MethodDesc versioningCallerMethod = callerMethod is UnboxingStub unboxingStub
                ? unboxingStub.TargetMethod
                : callerMethod;
            ...
            ref CORINFO_LOOKUP pResultLookup)
        {
            ...
            {
                var methodIL = HandleToObject(pResolvedToken.tokenScope);
                MethodDesc sharedMethod = MethodBeingCompiled is UnboxingStub unboxingStub
                    ? unboxingStub.TargetMethod.GetSharedRuntimeFormMethodTarget()
