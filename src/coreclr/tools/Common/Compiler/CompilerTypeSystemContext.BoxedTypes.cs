...
namespace ILCompiler
{
    ...
    {
        private interface IUnboxingThunk
        {
            MethodDesc TargetMethod { get; }
        }
        ...
        {
            return method.GetTypicalMethodDefinition() is IUnboxingThunk;
        }
        ...
        {
            MethodDesc typicalMethodTarget = ((IUnboxingThunk)method.GetTypicalMethodDefinition()).TargetMethod;
        ...
        /// </summary>
        private sealed class GenericUnboxingThunk : ILStubMethod, IPrefixMangledMethod, IUnboxingThunk
        {
        ...
        /// </summary>
        private sealed class UnboxingThunk : ILStubMethod, IPrefixMangledMethod, IUnboxingThunk
        {
            private MethodDesc _targetMethod;
            private BoxedValueType _owningType;
