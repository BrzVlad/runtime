...
#define g_realloc_vb(obj,size) (g_realloc_verbose (obj, size, FILE_LINE))
#define g_malloc_vb(size) (g_malloc_verbose (size, FILE_LINE))
#define g_malloc0_vb(size) (g_malloc0_verbose (size, FILE_LINE))
#define g_calloc_vb(n,x) (g_calloc_verbose (n, x, FILE_LINE))
#define g_try_malloc_vb(x) (g_try_malloc_verbose (x, FILE_LINE))
#define g_try_realloc_vb(obj,size) (g_try_realloc_verbose (obj, size, FILE_LINE))

#define g_new(type,size)        ((type *) g_malloc_verbose (sizeof (type) * (size), FILE_LINE))
#define g_new0(type,size)       ((type *) g_malloc0_verbose (sizeof (type)* (size), FILE_LINE))
